...
export function renderCodexSkillFile(packageName = "descuff"): string {
  return [
    ...
    "9. Report baseline, enrichment result, files changed, final validation, optional scenario/recon results, and remaining blockers. If Graphify was used, keep its output as compact supporting evidence and end with a Descuff-specific next step.",
    "",
